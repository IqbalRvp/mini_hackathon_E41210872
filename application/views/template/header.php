                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="<?php echo base_url('Admin/info');?>" aria-expanded="true"><i class="ti-pie-chart"></i><span>Info</span></a>
                               
                            </li>
                            <li>
                                <a href="<?php echo base_url('Admin/lokasi');?>" aria-expanded="true"><i class="ti-layout-sidebar-left"></i><span>Lokasi</span></a>
                               
                            </li>
                            <li>
                                <a href="<?php echo base_url('Admin/kategori');?>" aria-expanded="true"><i class="ti-palette"></i><span>Kategori</span></a>
                              
                            </li>
                            <li>
                                <a href="<?php echo base_url('Admin/berita');?>" aria-expanded="true"><i class="ti-slice"></i><span>Berita</span></a>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Pariwisata</a></li>
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Mochammad Iqbal Hidayatullah <i class="fa fa-angle-down"></i></h4>
